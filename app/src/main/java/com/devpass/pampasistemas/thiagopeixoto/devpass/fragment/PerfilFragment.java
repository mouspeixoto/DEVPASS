...
import com.devpass.pampasistemas.thiagopeixoto.devpass.activity.EditarPerfilActivity;
...
public class PerfilFragment extends Fragment {
    ...
    private TextView textPublicacoes, textSeguidores, textSeguindo,textNome;
    ...
    private void inicializarComponentes(View view){
        gridViewPerfil = view.findViewById(R.id.gridtest);
        ...
        textNome = view.findViewById(R.id.perfilNomeUsario);
    }
