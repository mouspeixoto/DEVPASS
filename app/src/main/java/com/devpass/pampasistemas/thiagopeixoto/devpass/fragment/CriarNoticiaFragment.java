 ...
 */
public class CriarNoticiaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_criar_noticia, container, false);

        //Validar permissões
        Permissao.validarPermissoes(permissoesNecessarias, getActivity(), 1 );

        //Inicializar componentes
        buttonAbrirCamera = view.findViewById(R.id.buttonModAbrirCamera);
        buttonAbrirGaleria = view.findViewById(R.id.buttonModAbrirGaleria);
        ...
        if( resultCode == getActivity().RESULT_OK ){
            ...
            try {
                ...
                if( imagem != null ){
                    ...
                    Intent i = new Intent(getActivity(), CriarPostagemActivity.class);
                    i.putExtra("fotoPostagemEscolhida", dadosImagem );
                    startActivity( i );
